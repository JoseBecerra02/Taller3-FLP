...
;#|
;Función: decorate
;Propósito: Hacer uso del concepto de decoradores
;Text x <procedimiento> x <procedimiento> -> Text
;@integrantes:: <procedimiento>
;@saludar:: <procedimiento>
;@decorate:: <procedimiento>
;
;declararRec(
;@integrantes()= 'EstebanSergioNataliajoseJuan';
;@saludar(@func) = ('hola:' concat evaluar @func() finEval);
;@decorate(@final)= (evaluar @saludar(@integrantes) finEval concat @final))
