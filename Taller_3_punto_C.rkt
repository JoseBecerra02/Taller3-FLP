...
(define list-index
 ...
 #|Punto C
   ...
   Función: sumaRec
   Propósito: Suma de forma recursiva dos números
   int x int -> int
   x :: int
   y :: int

declararRec (@sumaRec(@x, @y)= Si @y entonces add1(evaluar @sumaRec(@x,sub1(@y)) finEval) sino @x finSI)
{evaluar @sumaRec(2, 5) finEval}
